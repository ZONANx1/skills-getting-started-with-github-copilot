...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice shooting, passing, and teamwork in competitive basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Develop ball handling skills and compete in soccer matches",
